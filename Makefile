#############################################################################
# Makefile for building: Wizcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: sáb mar 22 08:16:06 2014
# Project:  Wizcoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_QRCODE=1 USE_UPNP=1 USE_DBUS=1 USE_IPV6=1 -o Makefile Wizcoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/emb/Escritorio/Wizcoin-classic/src/leveldb/libleveldb.a /home/emb/Escritorio/Wizcoin-classic/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtDBus -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/Wizcoin.cpp \
		...
		src/qt/qrcodedialog.cpp build/moc_Wizcoingui.cpp \
		...
		build/moc_Wizcoinaddressvalidator.cpp \
		...
		build/moc_Wizcoinamountfield.cpp \
...
OBJECTS       = build/Wizcoin.o \
		...
		build/Wizcoinaddressvalidator.o \
		build/alert.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		...
		build/Wizcoinstrings.o \
		build/Wizcoinamountfield.o \
		build/wallet.o \
		build/keystore.o \
		...
		build/moc_Wizcoinaddressvalidator.o \
		...
		build/moc_Wizcoinamountfield.o \
...
$(TARGET): /home/emb/Escritorio/Wizcoin-classic/src/leveldb/libleveldb.a /home/emb/Escritorio/Wizcoin-classic/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Wizcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_DBUS=1 USE_IPV6=1 -o Makefile Wizcoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/Wizcoin-qt0.8.6.2 || $(MKDIR) build/Wizcoin-qt0.8.6.2 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/locale/Wizcoin_af_ZA.ts src/qt/locale/Wizcoin_ar.ts src/qt/locale/Wizcoin_bg.ts src/qt/locale/Wizcoin_bs.ts src/qt/locale/Wizcoin_ca.ts src/qt/locale/Wizcoin_ca_ES.ts src/qt/locale/Wizcoin_cs.ts src/qt/locale/Wizcoin_cy.ts src/qt/locale/Wizcoin_da.ts src/qt/locale/Wizcoin_de.ts src/qt/locale/Wizcoin_el_GR.ts src/qt/locale/Wizcoin_en.ts src/qt/locale/Wizcoin_eo.ts src/qt/locale/Wizcoin_es.ts src/qt/locale/Wizcoin_es_CL.ts src/qt/locale/Wizcoin_et.ts src/qt/locale/Wizcoin_eu_ES.ts src/qt/locale/Wizcoin_fa.ts src/qt/locale/Wizcoin_fa_IR.ts src/qt/locale/Wizcoin_fi.ts src/qt/locale/Wizcoin_fr.ts src/qt/locale/Wizcoin_fr_CA.ts src/qt/locale/Wizcoin_gu_IN.ts src/qt/locale/Wizcoin_he.ts src/qt/locale/Wizcoin_hi_IN.ts src/qt/locale/Wizcoin_hr.ts src/qt/locale/Wizcoin_hu.ts src/qt/locale/Wizcoin_it.ts src/qt/locale/Wizcoin_ja.ts src/qt/locale/Wizcoin_la.ts src/qt/locale/Wizcoin_lt.ts src/qt/locale/Wizcoin_lv_LV.ts src/qt/locale/Wizcoin_nb.ts src/qt/locale/Wizcoin_nl.ts src/qt/locale/Wizcoin_pl.ts src/qt/locale/Wizcoin_pt_BR.ts src/qt/locale/Wizcoin_pt_PT.ts src/qt/locale/Wizcoin_ro_RO.ts src/qt/locale/Wizcoin_ru.ts src/qt/locale/Wizcoin_sk.ts src/qt/locale/Wizcoin_sr.ts src/qt/locale/Wizcoin_sv.ts src/qt/locale/Wizcoin_th_TH.ts src/qt/locale/Wizcoin_tr.ts src/qt/locale/Wizcoin_uk.ts src/qt/locale/Wizcoin_zh_CN.ts src/qt/locale/Wizcoin_zh_TW.ts build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/Wizcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/Wizcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/Wizcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/Wizcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/Wizcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/qrcodedialog.h build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/Wizcoin.qrc build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/Wizcoin.cpp src/qt/Wizcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/Wizcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/Wizcoinstrings.cpp src/qt/Wizcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/Wizcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/Wizcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/qt/qrcodedialog.cpp build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/qrcodedialog.ui build/Wizcoin-qt0.8.6.2/ && $(COPY_FILE) --parents src/qt/locale/Wizcoin_af_ZA.ts src/qt/locale/Wizcoin_ar.ts src/qt/locale/Wizcoin_bg.ts src/qt/locale/Wizcoin_bs.ts src/qt/locale/Wizcoin_ca.ts src/qt/locale/Wizcoin_ca_ES.ts src/qt/locale/Wizcoin_cs.ts src/qt/locale/Wizcoin_cy.ts src/qt/locale/Wizcoin_da.ts src/qt/locale/Wizcoin_de.ts src/qt/locale/Wizcoin_el_GR.ts src/qt/locale/Wizcoin_en.ts src/qt/locale/Wizcoin_eo.ts src/qt/locale/Wizcoin_es.ts src/qt/locale/Wizcoin_es_CL.ts src/qt/locale/Wizcoin_et.ts src/qt/locale/Wizcoin_eu_ES.ts src/qt/locale/Wizcoin_fa.ts src/qt/locale/Wizcoin_fa_IR.ts src/qt/locale/Wizcoin_fi.ts src/qt/locale/Wizcoin_fr.ts src/qt/locale/Wizcoin_fr_CA.ts src/qt/locale/Wizcoin_gu_IN.ts src/qt/locale/Wizcoin_he.ts src/qt/locale/Wizcoin_hi_IN.ts src/qt/locale/Wizcoin_hr.ts src/qt/locale/Wizcoin_hu.ts src/qt/locale/Wizcoin_it.ts src/qt/locale/Wizcoin_ja.ts src/qt/locale/Wizcoin_la.ts src/qt/locale/Wizcoin_lt.ts src/qt/locale/Wizcoin_lv_LV.ts src/qt/locale/Wizcoin_nb.ts src/qt/locale/Wizcoin_nl.ts src/qt/locale/Wizcoin_pl.ts src/qt/locale/Wizcoin_pt_BR.ts src/qt/locale/Wizcoin_pt_PT.ts src/qt/locale/Wizcoin_ro_RO.ts src/qt/locale/Wizcoin_ru.ts src/qt/locale/Wizcoin_sk.ts src/qt/locale/Wizcoin_sr.ts src/qt/locale/Wizcoin_sv.ts src/qt/locale/Wizcoin_th_TH.ts src/qt/locale/Wizcoin_tr.ts src/qt/locale/Wizcoin_uk.ts src/qt/locale/Wizcoin_zh_CN.ts src/qt/locale/Wizcoin_zh_TW.ts build/Wizcoin-qt0.8.6.2/ && (cd `dirname build/Wizcoin-qt0.8.6.2` && $(TAR) Wizcoin-qt0.8.6.2.tar Wizcoin-qt0.8.6.2 && $(COMPRESS) Wizcoin-qt0.8.6.2.tar) && $(MOVE) `dirname build/Wizcoin-qt0.8.6.2`/Wizcoin-qt0.8.6.2.tar.gz . && $(DEL_FILE) -r build/Wizcoin-qt0.8.6.2


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/emb/Escritorio/Wizcoin-classic/src/leveldb/libleveldb.a; cd /home/emb/Escritorio/Wizcoin-classic/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/emb/Escritorio/Wizcoin-classic/src/leveldb/libleveldb.a: FORCE
	cd /home/emb/Escritorio/Wizcoin-classic/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/emb/Escritorio/Wizcoin-classic/build/build.h: FORCE
	cd /home/emb/Escritorio/Wizcoin-classic; /bin/sh share/genbuild.sh /home/emb/Escritorio/Wizcoin-classic/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/Wizcoin_af_ZA.qm src/qt/locale/Wizcoin_ar.qm src/qt/locale/Wizcoin_bg.qm src/qt/locale/Wizcoin_bs.qm src/qt/locale/Wizcoin_ca.qm src/qt/locale/Wizcoin_ca_ES.qm src/qt/locale/Wizcoin_cs.qm src/qt/locale/Wizcoin_cy.qm src/qt/locale/Wizcoin_da.qm src/qt/locale/Wizcoin_de.qm src/qt/locale/Wizcoin_el_GR.qm src/qt/locale/Wizcoin_en.qm src/qt/locale/Wizcoin_eo.qm src/qt/locale/Wizcoin_es.qm src/qt/locale/Wizcoin_es_CL.qm src/qt/locale/Wizcoin_et.qm src/qt/locale/Wizcoin_eu_ES.qm src/qt/locale/Wizcoin_fa.qm src/qt/locale/Wizcoin_fa_IR.qm src/qt/locale/Wizcoin_fi.qm src/qt/locale/Wizcoin_fr.qm src/qt/locale/Wizcoin_fr_CA.qm src/qt/locale/Wizcoin_gu_IN.qm src/qt/locale/Wizcoin_he.qm src/qt/locale/Wizcoin_hi_IN.qm src/qt/locale/Wizcoin_hr.qm src/qt/locale/Wizcoin_hu.qm src/qt/locale/Wizcoin_it.qm src/qt/locale/Wizcoin_ja.qm src/qt/locale/Wizcoin_la.qm src/qt/locale/Wizcoin_lt.qm src/qt/locale/Wizcoin_lv_LV.qm src/qt/locale/Wizcoin_nb.qm src/qt/locale/Wizcoin_nl.qm src/qt/locale/Wizcoin_pl.qm src/qt/locale/Wizcoin_pt_BR.qm src/qt/locale/Wizcoin_pt_PT.qm src/qt/locale/Wizcoin_ro_RO.qm src/qt/locale/Wizcoin_ru.qm src/qt/locale/Wizcoin_sk.qm src/qt/locale/Wizcoin_sr.qm src/qt/locale/Wizcoin_sv.qm src/qt/locale/Wizcoin_th_TH.qm src/qt/locale/Wizcoin_tr.qm src/qt/locale/Wizcoin_uk.qm src/qt/locale/Wizcoin_zh_CN.qm src/qt/locale/Wizcoin_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/Wizcoin_af_ZA.qm src/qt/locale/Wizcoin_ar.qm src/qt/locale/Wizcoin_bg.qm src/qt/locale/Wizcoin_bs.qm src/qt/locale/Wizcoin_ca.qm src/qt/locale/Wizcoin_ca_ES.qm src/qt/locale/Wizcoin_cs.qm src/qt/locale/Wizcoin_cy.qm src/qt/locale/Wizcoin_da.qm src/qt/locale/Wizcoin_de.qm src/qt/locale/Wizcoin_el_GR.qm src/qt/locale/Wizcoin_en.qm src/qt/locale/Wizcoin_eo.qm src/qt/locale/Wizcoin_es.qm src/qt/locale/Wizcoin_es_CL.qm src/qt/locale/Wizcoin_et.qm src/qt/locale/Wizcoin_eu_ES.qm src/qt/locale/Wizcoin_fa.qm src/qt/locale/Wizcoin_fa_IR.qm src/qt/locale/Wizcoin_fi.qm src/qt/locale/Wizcoin_fr.qm src/qt/locale/Wizcoin_fr_CA.qm src/qt/locale/Wizcoin_gu_IN.qm src/qt/locale/Wizcoin_he.qm src/qt/locale/Wizcoin_hi_IN.qm src/qt/locale/Wizcoin_hr.qm src/qt/locale/Wizcoin_hu.qm src/qt/locale/Wizcoin_it.qm src/qt/locale/Wizcoin_ja.qm src/qt/locale/Wizcoin_la.qm src/qt/locale/Wizcoin_lt.qm src/qt/locale/Wizcoin_lv_LV.qm src/qt/locale/Wizcoin_nb.qm src/qt/locale/Wizcoin_nl.qm src/qt/locale/Wizcoin_pl.qm src/qt/locale/Wizcoin_pt_BR.qm src/qt/locale/Wizcoin_pt_PT.qm src/qt/locale/Wizcoin_ro_RO.qm src/qt/locale/Wizcoin_ru.qm src/qt/locale/Wizcoin_sk.qm src/qt/locale/Wizcoin_sr.qm src/qt/locale/Wizcoin_sv.qm src/qt/locale/Wizcoin_th_TH.qm src/qt/locale/Wizcoin_tr.qm src/qt/locale/Wizcoin_uk.qm src/qt/locale/Wizcoin_zh_CN.qm src/qt/locale/Wizcoin_zh_TW.qm
src/qt/locale/Wizcoin_af_ZA.qm: src/qt/locale/Wizcoin_af_ZA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_af_ZA.ts -qm src/qt/locale/Wizcoin_af_ZA.qm

src/qt/locale/Wizcoin_ar.qm: src/qt/locale/Wizcoin_ar.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ar.ts -qm src/qt/locale/Wizcoin_ar.qm

src/qt/locale/Wizcoin_bg.qm: src/qt/locale/Wizcoin_bg.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_bg.ts -qm src/qt/locale/Wizcoin_bg.qm

src/qt/locale/Wizcoin_bs.qm: src/qt/locale/Wizcoin_bs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_bs.ts -qm src/qt/locale/Wizcoin_bs.qm

src/qt/locale/Wizcoin_ca.qm: src/qt/locale/Wizcoin_ca.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ca.ts -qm src/qt/locale/Wizcoin_ca.qm

src/qt/locale/Wizcoin_ca_ES.qm: src/qt/locale/Wizcoin_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ca_ES.ts -qm src/qt/locale/Wizcoin_ca_ES.qm

src/qt/locale/Wizcoin_cs.qm: src/qt/locale/Wizcoin_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_cs.ts -qm src/qt/locale/Wizcoin_cs.qm

src/qt/locale/Wizcoin_cy.qm: src/qt/locale/Wizcoin_cy.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_cy.ts -qm src/qt/locale/Wizcoin_cy.qm

src/qt/locale/Wizcoin_da.qm: src/qt/locale/Wizcoin_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_da.ts -qm src/qt/locale/Wizcoin_da.qm

src/qt/locale/Wizcoin_de.qm: src/qt/locale/Wizcoin_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_de.ts -qm src/qt/locale/Wizcoin_de.qm

src/qt/locale/Wizcoin_el_GR.qm: src/qt/locale/Wizcoin_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_el_GR.ts -qm src/qt/locale/Wizcoin_el_GR.qm

src/qt/locale/Wizcoin_en.qm: src/qt/locale/Wizcoin_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_en.ts -qm src/qt/locale/Wizcoin_en.qm

src/qt/locale/Wizcoin_eo.qm: src/qt/locale/Wizcoin_eo.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_eo.ts -qm src/qt/locale/Wizcoin_eo.qm

src/qt/locale/Wizcoin_es.qm: src/qt/locale/Wizcoin_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_es.ts -qm src/qt/locale/Wizcoin_es.qm

src/qt/locale/Wizcoin_es_CL.qm: src/qt/locale/Wizcoin_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_es_CL.ts -qm src/qt/locale/Wizcoin_es_CL.qm

src/qt/locale/Wizcoin_et.qm: src/qt/locale/Wizcoin_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_et.ts -qm src/qt/locale/Wizcoin_et.qm

src/qt/locale/Wizcoin_eu_ES.qm: src/qt/locale/Wizcoin_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_eu_ES.ts -qm src/qt/locale/Wizcoin_eu_ES.qm

src/qt/locale/Wizcoin_fa.qm: src/qt/locale/Wizcoin_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_fa.ts -qm src/qt/locale/Wizcoin_fa.qm

src/qt/locale/Wizcoin_fa_IR.qm: src/qt/locale/Wizcoin_fa_IR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_fa_IR.ts -qm src/qt/locale/Wizcoin_fa_IR.qm

src/qt/locale/Wizcoin_fi.qm: src/qt/locale/Wizcoin_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_fi.ts -qm src/qt/locale/Wizcoin_fi.qm

src/qt/locale/Wizcoin_fr.qm: src/qt/locale/Wizcoin_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_fr.ts -qm src/qt/locale/Wizcoin_fr.qm

src/qt/locale/Wizcoin_fr_CA.qm: src/qt/locale/Wizcoin_fr_CA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_fr_CA.ts -qm src/qt/locale/Wizcoin_fr_CA.qm

src/qt/locale/Wizcoin_gu_IN.qm: src/qt/locale/Wizcoin_gu_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_gu_IN.ts -qm src/qt/locale/Wizcoin_gu_IN.qm

src/qt/locale/Wizcoin_he.qm: src/qt/locale/Wizcoin_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_he.ts -qm src/qt/locale/Wizcoin_he.qm

src/qt/locale/Wizcoin_hi_IN.qm: src/qt/locale/Wizcoin_hi_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_hi_IN.ts -qm src/qt/locale/Wizcoin_hi_IN.qm

src/qt/locale/Wizcoin_hr.qm: src/qt/locale/Wizcoin_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_hr.ts -qm src/qt/locale/Wizcoin_hr.qm

src/qt/locale/Wizcoin_hu.qm: src/qt/locale/Wizcoin_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_hu.ts -qm src/qt/locale/Wizcoin_hu.qm

src/qt/locale/Wizcoin_it.qm: src/qt/locale/Wizcoin_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_it.ts -qm src/qt/locale/Wizcoin_it.qm

src/qt/locale/Wizcoin_ja.qm: src/qt/locale/Wizcoin_ja.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ja.ts -qm src/qt/locale/Wizcoin_ja.qm

src/qt/locale/Wizcoin_la.qm: src/qt/locale/Wizcoin_la.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_la.ts -qm src/qt/locale/Wizcoin_la.qm

src/qt/locale/Wizcoin_lt.qm: src/qt/locale/Wizcoin_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_lt.ts -qm src/qt/locale/Wizcoin_lt.qm

src/qt/locale/Wizcoin_lv_LV.qm: src/qt/locale/Wizcoin_lv_LV.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_lv_LV.ts -qm src/qt/locale/Wizcoin_lv_LV.qm

src/qt/locale/Wizcoin_nb.qm: src/qt/locale/Wizcoin_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_nb.ts -qm src/qt/locale/Wizcoin_nb.qm

src/qt/locale/Wizcoin_nl.qm: src/qt/locale/Wizcoin_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_nl.ts -qm src/qt/locale/Wizcoin_nl.qm

src/qt/locale/Wizcoin_pl.qm: src/qt/locale/Wizcoin_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_pl.ts -qm src/qt/locale/Wizcoin_pl.qm

src/qt/locale/Wizcoin_pt_BR.qm: src/qt/locale/Wizcoin_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_pt_BR.ts -qm src/qt/locale/Wizcoin_pt_BR.qm

src/qt/locale/Wizcoin_pt_PT.qm: src/qt/locale/Wizcoin_pt_PT.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_pt_PT.ts -qm src/qt/locale/Wizcoin_pt_PT.qm

src/qt/locale/Wizcoin_ro_RO.qm: src/qt/locale/Wizcoin_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ro_RO.ts -qm src/qt/locale/Wizcoin_ro_RO.qm

src/qt/locale/Wizcoin_ru.qm: src/qt/locale/Wizcoin_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_ru.ts -qm src/qt/locale/Wizcoin_ru.qm

src/qt/locale/Wizcoin_sk.qm: src/qt/locale/Wizcoin_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_sk.ts -qm src/qt/locale/Wizcoin_sk.qm

src/qt/locale/Wizcoin_sr.qm: src/qt/locale/Wizcoin_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_sr.ts -qm src/qt/locale/Wizcoin_sr.qm

src/qt/locale/Wizcoin_sv.qm: src/qt/locale/Wizcoin_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_sv.ts -qm src/qt/locale/Wizcoin_sv.qm

src/qt/locale/Wizcoin_th_TH.qm: src/qt/locale/Wizcoin_th_TH.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_th_TH.ts -qm src/qt/locale/Wizcoin_th_TH.qm

src/qt/locale/Wizcoin_tr.qm: src/qt/locale/Wizcoin_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_tr.ts -qm src/qt/locale/Wizcoin_tr.qm

src/qt/locale/Wizcoin_uk.qm: src/qt/locale/Wizcoin_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_uk.ts -qm src/qt/locale/Wizcoin_uk.qm

src/qt/locale/Wizcoin_zh_CN.qm: src/qt/locale/Wizcoin_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_zh_CN.ts -qm src/qt/locale/Wizcoin_zh_CN.qm

src/qt/locale/Wizcoin_zh_TW.qm: src/qt/locale/Wizcoin_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/Wizcoin_zh_TW.ts -qm src/qt/locale/Wizcoin_zh_TW.qm

compiler_moc_header_make_all: build/moc_Wizcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_Wizcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_Wizcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_Wizcoinunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_macnotificationhandler.cpp build/moc_splashscreen.cpp build/moc_qrcodedialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_Wizcoingui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_Wizcoinaddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_Wizcoinamountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_Wizcoinunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_macnotificationhandler.cpp build/moc_splashscreen.cpp build/moc_qrcodedialog.cpp
build/moc_Wizcoingui.cpp: src/qt/Wizcoingui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/Wizcoingui.h -o build/moc_Wizcoingui.cpp
...
build/moc_Wizcoinaddressvalidator.cpp: src/qt/Wizcoinaddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/Wizcoinaddressvalidator.h -o build/moc_Wizcoinaddressvalidator.cpp
...
build/moc_Wizcoinamountfield.cpp: src/qt/Wizcoinamountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/Wizcoinamountfield.h -o build/moc_Wizcoinamountfield.cpp
...
build/moc_Wizcoinunits.cpp: src/qt/Wizcoinunits.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/Wizcoinunits.h -o build/moc_Wizcoinunits.cpp
...
compiler_rcc_make_all: qrc_Wizcoin.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_Wizcoin.cpp
qrc_Wizcoin.cpp: src/qt/Wizcoin.qrc \
		src/qt/locale/Wizcoin_fr.qm \
		src/qt/locale/Wizcoin_sk.qm \
		src/qt/locale/Wizcoin_ca.qm \
		src/qt/locale/Wizcoin_bs.qm \
		src/qt/locale/Wizcoin_sr.qm \
		src/qt/locale/Wizcoin_hi_IN.qm \
		src/qt/locale/Wizcoin_sv.qm \
		src/qt/locale/Wizcoin_la.qm \
		src/qt/locale/Wizcoin_pt_BR.qm \
		src/qt/locale/Wizcoin_da.qm \
		src/qt/locale/Wizcoin_zh_CN.qm \
		src/qt/locale/Wizcoin_he.qm \
		src/qt/locale/Wizcoin_pl.qm \
		src/qt/locale/Wizcoin_cs.qm \
		src/qt/locale/Wizcoin_lv_LV.qm \
		src/qt/locale/Wizcoin_de.qm \
		src/qt/locale/Wizcoin_th_TH.qm \
		src/qt/locale/Wizcoin_tr.qm \
		src/qt/locale/Wizcoin_cy.qm \
		src/qt/locale/Wizcoin_eu_ES.qm \
		src/qt/locale/Wizcoin_fr_CA.qm \
		src/qt/locale/Wizcoin_ca_ES.qm \
		src/qt/locale/Wizcoin_lt.qm \
		src/qt/locale/Wizcoin_zh_TW.qm \
		src/qt/locale/Wizcoin_hr.qm \
		src/qt/locale/Wizcoin_uk.qm \
		src/qt/locale/Wizcoin_hu.qm \
		src/qt/locale/Wizcoin_af_ZA.qm \
		src/qt/locale/Wizcoin_es_CL.qm \
		src/qt/locale/Wizcoin_pt_PT.qm \
		src/qt/locale/Wizcoin_gu_IN.qm \
		src/qt/locale/Wizcoin_ro_RO.qm \
		src/qt/locale/Wizcoin_nb.qm \
		src/qt/locale/Wizcoin_el_GR.qm \
		src/qt/locale/Wizcoin_ja.qm \
		src/qt/locale/Wizcoin_en.qm \
		src/qt/locale/Wizcoin_eo.qm \
		src/qt/locale/Wizcoin_it.qm \
		src/qt/locale/Wizcoin_fa.qm \
		src/qt/locale/Wizcoin_es.qm \
		src/qt/locale/Wizcoin_et.qm \
		src/qt/locale/Wizcoin_ar.qm \
		src/qt/locale/Wizcoin_nl.qm \
		src/qt/locale/Wizcoin_fa_IR.qm \
		src/qt/locale/Wizcoin_fi.qm \
		src/qt/locale/Wizcoin_bg.qm \
		src/qt/locale/Wizcoin_ru.qm \
		...
		src/qt/res/icons/Wizcoin_testnet.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name Wizcoin src/qt/Wizcoin.qrc -o qrc_Wizcoin.cpp
...
build/Wizcoin.o: src/qt/Wizcoin.cpp src/qt/Wizcoingui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoin.o src/qt/Wizcoin.cpp

build/Wizcoingui.o: src/qt/Wizcoingui.cpp src/qt/Wizcoingui.h \
		src/qt/transactiontablemodel.h \
		...
		src/init.h \
		src/qt/macdockiconhandler.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoingui.o src/qt/Wizcoingui.cpp
...
build/Wizcoinaddressvalidator.o: src/qt/Wizcoinaddressvalidator.cpp src/qt/Wizcoinaddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoinaddressvalidator.o src/qt/Wizcoinaddressvalidator.cpp
...
build/Wizcoinstrings.o: src/qt/Wizcoinstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoinstrings.o src/qt/Wizcoinstrings.cpp

build/Wizcoinamountfield.o: src/qt/Wizcoinamountfield.cpp src/qt/Wizcoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/Wizcoinunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoinamountfield.o src/qt/Wizcoinamountfield.cpp
...
build/Wizcoinrpc.o: src/Wizcoinrpc.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_writer_template.h \
		src/json/json_spirit_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoinrpc.o src/Wizcoinrpc.cpp
...
build/Wizcoinunits.o: src/qt/Wizcoinunits.cpp src/qt/Wizcoinunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Wizcoinunits.o src/qt/Wizcoinunits.cpp
...
build/moc_Wizcoingui.o: build/moc_Wizcoingui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_Wizcoingui.o build/moc_Wizcoingui.cpp
...
build/moc_Wizcoinaddressvalidator.o: build/moc_Wizcoinaddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_Wizcoinaddressvalidator.o build/moc_Wizcoinaddressvalidator.cpp
...
build/moc_Wizcoinamountfield.o: build/moc_Wizcoinamountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_Wizcoinamountfield.o build/moc_Wizcoinamountfield.cpp
...
build/moc_Wizcoinunits.o: build/moc_Wizcoinunits.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_Wizcoinunits.o build/moc_Wizcoinunits.cpp
...
build/qrc_Wizcoin.o: qrc_Wizcoin.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_Wizcoin.o qrc_Wizcoin.cpp
