...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // WizCoin: 1 days
static const int64 nTargetSpacing = 120; // WizCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal WizCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WizCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd7ba4921dd71ce590c8e8ae7a0cbbf72369435b205b347fef19c4df5b77fcb65");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1395611229; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0x062055bb8894945084846151aebac4b20cad195a6197ddfada10b9d51ac006b1"));
