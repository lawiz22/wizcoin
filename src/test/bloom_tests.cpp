...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize)
{
    ...
    CDataStream stream(SER_NETWORK, PWIZOCOL_VERSION);
    filter.Serialize(stream, SER_NETWORK, PWIZOCOL_VERSION);
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
    ...
    CDataStream merkleStream(SER_NETWORK, PWIZOCOL_VERSION);
